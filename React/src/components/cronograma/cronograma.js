    ...
    <div style={{ padding: "20px", backgroundColor: "#ffffff", minHeight: "100vh" }}>
      ...
      <FullCalendar
        ...
        events={eventosFiltrados.map((e) => ({
          ...
          display: e.habilitado ? "auto" : "block", // ahora se ve como evento pequeño
          color: e.habilitado ? eventColors[e.tipo] : "#d3d3d3", // gris si está deshabilitado
        }))}
        ...
        <Modal.Body>
          <Form.Group>
            ...
            <Form.Control
              ...
              onChange={(e) =>
                setNewEvent({ ...newEvent, clienteId: e.target.value })
              }
